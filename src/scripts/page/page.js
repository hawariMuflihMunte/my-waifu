...
const PAGE = {
  ...
  <div class="bg-transparent w-screen h-screen flex place-content-center place-items-center">
    <div class="flex-col max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-2xl text-center">
      <div id="${CONFIG.GENERATOR_IMAGE_CONTAINER_ID}" class="max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-2xl border-collapse border-2 border-sky-300 text-center mb-4">💕</div>
